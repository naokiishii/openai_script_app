...
def num_tokens_from_messages(messages, model="gpt-3.5-turbo-0613"):
    ...
    if model in {
        ...
        raise NotImplementedError(
            f"""num_tokens_from_messages() is not implemented for model {model}. See https://cookbook.openai.com/examples/how_to_count_tokens_with_tiktoken for information on how messages are converted to tokens."""
        )
    num_tokens = 0

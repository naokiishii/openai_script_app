...
def print_diff_and_prompt_user_to_accept_or_reject_change(
    ...
    return input(style("Your reply [Y/N/q/<whatever you want>]: ", "bold"))
...
def main():
    ...
    parser.add_argument(
        "--model",
        default="gpt-4o-mini",
        help="The chat model to use for code review (default: gpt-4o-mini)",
    )
